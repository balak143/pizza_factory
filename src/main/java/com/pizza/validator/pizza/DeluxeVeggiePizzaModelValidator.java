...
/**
 * Any specific validations for Deluxe Veggies Pizza would go here. This will not do anything extra,
 * this can be extended in future
 */
public class DeluxeVeggiePizzaModelValidator
    extends AbstractPizzaModelValidator<DeluxeVeggiePizzaModel> {
