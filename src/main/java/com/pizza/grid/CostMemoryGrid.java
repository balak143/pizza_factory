...
/**
 * Cost Memory grid hold cached data in TreeMap. Reason for choosing TreeMap to get the nearest
 * available prices to applied if store decide to use dynamic fares based on the demand and cost of
 * the ingredients changes everyday.
 */
