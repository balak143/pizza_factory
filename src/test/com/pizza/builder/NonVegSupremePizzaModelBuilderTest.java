...
public class NonVegSupremePizzaModelBuilderTest {
    NonVegSupremePizzaModelBuilder pizzaModelBuilder = null;
    ...
    public void validate_build_for_pizzaIngredients() throws ApplicationException {
        ...
        pizzaModelBuilder = new NonVegSupremePizzaModelBuilder(pizzaInputData);
        AbstractPizzaModel pizzaModel = pizzaModelBuilder.build(context);

        Assert.assertEquals("Non-Veg Supreme", pizzaModel.getName());
        ...
        Assert.assertEquals("Ingredients Size should be 8 ", 8, ingredients.size());
        ...
        List<String> expectedList = Arrays.asList(PizzaIngredientsName.SAUCE.getName(), PizzaIngredientsName.CHEESE.getName(),
                ...
                PizzaIngredientsName.GARLIC.getName(), PizzaIngredientsName.CORN.getName(), PizzaIngredientsName.CHICKEN.getName());
    ...
    public void validate_build_for_toppings() throws ApplicationException {
        ...
        List<String> expectedList = Arrays.asList(ToppingName.CAPSICUM.getName(), ToppingName.BLACK_OLIVE.getName());
    ...
    public void validate_getMultiplier_for_size_large() throws ApplicationException {
        ...
        Assert.assertEquals("Multiplier is not 2.24", 2.24, multiplier, 0.000000d);
    }
    ...
    public void validate_getMultiplier_for_size_medium() throws ApplicationException {
        ...
        Assert.assertEquals("Multiplier is not 1.712", 1.712, multiplier, 0.000000d);
    }
    ...
    private PizzaInputData preparePizzaInputDataForDeluxeVeggiePizza() {
        ...
        PizzaInputData pizzaInputData = new PizzaInputData();
        pizzaInputData.setCrustName(CrustName.CHEESE_BURST.getName());
        pizzaInputData.setPizzaSize(Size.REGULAR.getName());
        pizzaInputData.setName(PizzaName.NONVEG_SUPREME.getName());
        pizzaInputData.addToppings(ToppingName.CAPSICUM.getName());
