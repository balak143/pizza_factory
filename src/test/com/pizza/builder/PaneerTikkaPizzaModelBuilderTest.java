...
public class PaneerTikkaPizzaModelBuilderTest {
    PaneerTikkaPizzaModelBuilder pizzaModelBuilder = null;
    ...
    public void validate_build_for_pizzaIngredients() throws ApplicationException {
        ...
        pizzaModelBuilder = new PaneerTikkaPizzaModelBuilder(pizzaInputData);
        AbstractPizzaModel pizzaModel = pizzaModelBuilder.build(context);

        Assert.assertEquals("Paneer Tikka", pizzaModel.getName());
        ...
        List<String> expectedList = Arrays.asList(PizzaIngredientsName.SAUCE.getName(), PizzaIngredientsName.CHEESE.getName(),
                ...
                PizzaIngredientsName.GARLIC.getName(),PizzaIngredientsName.PANEER_CHOP.getName());
    ...
    public void validate_getMultiplier_for_size_large() throws ApplicationException {
        ...
        Assert.assertEquals("Multiplier is not 2.125", 2.125, multiplier, 0.000000d);
    }
    ...
    public void validate_getMultiplier_for_size_medium() throws ApplicationException {
        ...
        Assert.assertEquals("Multiplier is not 1.815", 1.815, multiplier, 0.000000d);
    }
    ...
    public void validate_getType() throws ApplicationException {
        ...
        Assert.assertEquals("Paneer Tikka pizza type should be VEG", IngredientType.VEG, pizzaType);
    }
    ...
    private PizzaInputData preparePizzaInputDataForDeluxeVeggiePizza() {
        ...
        PizzaInputData pizzaInputData = new PizzaInputData();
        pizzaInputData.setCrustName(CrustName.NEW_HAND_TOSSED.getName());
