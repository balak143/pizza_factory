...
import com.pizza.grid.IngredientTestDB;
...
public class DeluxeVeggiePizzaModelValidatorTest {
    ...
    public void setup() {
        ...
        pizzaIngredientsModel.add(IngredientTestDB.EXTRA_CHEESE.ingredientModel());
        ...
        blackOliveToppingModel.setIngredientModel(IngredientTestDB.BLACK_OLIVE.ingredientModel());
    ...
    public void validate_veg_pizza_has_nonveg_tappings() throws Exception {
        ...
        chickenToppingModel.setIngredientModel(IngredientTestDB.CHICKEN_TIKKA.ingredientModel());
    ...
    public void validate_nonveg_pizza_cannot_have_paneer_tappings() throws Exception {
        ...
        paneerToppingModel.setIngredientModel(IngredientTestDB.PANEER.ingredientModel());
    ...
    public void validate_only_one_nonveg_topping_allowed_on_nonveg_pizza() throws Exception {
        ...
        pizzaIngredientsModel.add(IngredientTestDB.BARBEQUE_CHICKEN.ingredientModel());
        pizzaIngredientsModel.add(IngredientTestDB.CAPSICUM.ingredientModel());
        pizzaModel.setPizzaIngredientsModel(pizzaIngredientsModel);
        ChickenTikkaToppingModel chickenTikkaToppingModel = new ChickenTikkaToppingModel();
        chickenTikkaToppingModel.setIngredientModel(IngredientTestDB.CHICKEN_TIKKA.ingredientModel());
        ...
        grilledChickenToppingModel.setIngredientModel(IngredientTestDB.GRILLED_CHICKEN.ingredientModel());
